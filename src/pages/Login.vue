  ...
  <div class="flex items-center justify-center min-h-screen bg-gray-50">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
      ...
      <form @submit.prevent="onSubmit">
        <CustomInput v-model:modelValue="emailValue" label="Email" placeholder="Enter your email" :error="emailError" />

        <CustomInput v-model:modelValue="passwordValue" type="password" label="Password"
          placeholder="Enter your password" :error="passwordError" />
